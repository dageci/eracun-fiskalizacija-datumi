...
Ovaj dokument pokušava spojiti sva četiri izvora u konkretne primjere. Svaki naslov sekcije dobiva automatski **status badge** (Za pregled / U reviziji / Čeka PU / Potvrđeno) koji prikazuje trenutno stanje stručne revizije. Dok sadržaj nije eksplicitno potvrđen, treba ga tretirati kao prijedlog za raspravu, ne kao uputu.

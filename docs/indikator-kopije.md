...
| **VATEX kod** | BT-121 | PU navodno kaže da se može — ali VATEX određuje razlog oslobođenja od PDV-a (npr. reverse charge vs izvan opsega), što **direktno utječe na PDV tretman**. Smatramo da bi trebao biti u "NE SMIJE" kategoriji. |

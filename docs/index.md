...
Svaki segment dokumentacije (naslov sekcije) ima **automatski badge** koji prikazuje trenutno stanje revizije: <span style="display:inline-block;background:#f39c12;color:white;font-size:0.7rem;font-weight:600;padding:0.15rem 0.55rem;border-radius:3px;">Za pregled</span> <span style="display:inline-block;background:#1d76db;color:white;font-size:0.7rem;font-weight:600;padding:0.15rem 0.55rem;border-radius:3px;">U reviziji</span> <span style="display:inline-block;background:#5dade2;color:white;font-size:0.7rem;font-weight:600;padding:0.15rem 0.55rem;border-radius:3px;">Čeka PU</span> <span style="display:inline-block;background:#0e8a16;color:white;font-size:0.7rem;font-weight:600;padding:0.15rem 0.55rem;border-radius:3px;">Potvrđeno</span> <span style="display:inline-block;background:#94a3b8;color:white;font-size:0.7rem;font-weight:600;padding:0.15rem 0.55rem;border-radius:3px;">Izvan revizije</span>. Klikom na badge otvara se odgovarajući GitHub Issue gdje teče rasprava. Pregled napretka: [Napredak revizije](napredak).
</div>
